...
class cfunc_fourierrec(object):
    ...
    def __init__(self, nproj, nz, n):
        _cfunc_fourierrecfp16.cfunc_fourierrec_swiginit(self, _cfunc_fourierrecfp16.new_cfunc_fourierrec(nproj, nz, n))
    __swig_destroy__ = _cfunc_fourierrecfp16.delete_cfunc_fourierrec

    def backprojection(self, f, g, theta_, stream):
        return _cfunc_fourierrecfp16.cfunc_fourierrec_backprojection(self, f, g, theta_, stream)

    def projection(self, g, f, theta_, stream):
        return _cfunc_fourierrecfp16.cfunc_fourierrec_projection(self, g, f, theta_, stream)
